...
GO
PRINT N'Starting rebuilding table [dbo].[TblOrderItem]...';
...
CREATE TABLE [dbo].[tmp_ms_xx_TblOrderItem] (
    [orderItemID] INT   IDENTITY (1, 1) NOT NULL,
    [menuItemId]  INT   NOT NULL,
    [price]       MONEY NOT NULL,
    CONSTRAINT [tmp_ms_xx_constraint_PK_TblOrderItem1] PRIMARY KEY CLUSTERED ([orderItemID] ASC)
);

IF EXISTS (SELECT TOP 1 1 
           FROM   [dbo].[TblOrderItem])
    BEGIN
        SET IDENTITY_INSERT [dbo].[tmp_ms_xx_TblOrderItem] ON;
        INSERT INTO [dbo].[tmp_ms_xx_TblOrderItem] ([orderItemID], [menuItemId], [price])
        SELECT   [orderItemID],
                 [menuItemId],
                 [price]
        FROM     [dbo].[TblOrderItem]
        ORDER BY [orderItemID] ASC;
        SET IDENTITY_INSERT [dbo].[tmp_ms_xx_TblOrderItem] OFF;
    END

DROP TABLE [dbo].[TblOrderItem];

EXECUTE sp_rename N'[dbo].[tmp_ms_xx_TblOrderItem]', N'TblOrderItem';

EXECUTE sp_rename N'[dbo].[tmp_ms_xx_constraint_PK_TblOrderItem1]', N'PK_TblOrderItem', N'OBJECT';
