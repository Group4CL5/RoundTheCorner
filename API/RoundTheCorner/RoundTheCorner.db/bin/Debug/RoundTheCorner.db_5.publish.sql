...
GO
PRINT N'Dropping [dbo].[FK_MenuItem_Menus]...';


GO
ALTER TABLE [dbo].[TblMenuItem] DROP CONSTRAINT [FK_MenuItem_Menus];


GO
PRINT N'Dropping [dbo].[FK_MenuItem_Menus1]...';


GO
ALTER TABLE [dbo].[TblMenuItem] DROP CONSTRAINT [FK_MenuItem_Menus1];


GO
PRINT N'Dropping [dbo].[FK_Menus_Vendors]...';


GO
ALTER TABLE [dbo].[TblMenus] DROP CONSTRAINT [FK_Menus_Vendors];


GO
PRINT N'Dropping [dbo].[FK_MenuSection_Menus]...';


GO
ALTER TABLE [dbo].[TblMenuSection] DROP CONSTRAINT [FK_MenuSection_Menus];
